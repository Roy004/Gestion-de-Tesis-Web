            ...
            <div id="sidebar" class="navbar-collapse collapse">
                ...
                <ul class="nav nav-list">
                    ...
                    <li>
                        ...
                        <!-- BEGIN Submenu -->
                        <ul class="submenu">
                            <li><a href="formulario_1.html">Ingresar</a></li>
                            <li><a href="formulario_2.html">Eliminar</a></li>
                            <li><a href="formulario_3.html">Editar</a></li>
                            <li><a href="formulario_4.html">Actualizar</a></li>
                        </ul>
                        <!-- END Submenu -->
                    </li>
